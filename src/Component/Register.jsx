    ...
    return (
        <>
            ...
            <center>
                <div className="main">
                    <div>
                        <img style={{ width: '700px' }} src={'https://image.freepik.com/free-vector/login-concept-illustration_114360-739.jpg'} alt="" />
                    </div>
                    ...
                    <div className="register-container">
                        ...
                        <form onSubmit={Register} method='post' action='/'>
                            <h1 >Register</h1>
                            <div className='input'>
                                <TextField type='email' required placeholder='Enter Your Email' name='email' onChange={handleEmail} />
                            ...
                            <div className='input'>
                                <TextField type='password' required placeholder='Enter Your password' name='password' onChange={(e) => setPassword(e.target.value)} />
