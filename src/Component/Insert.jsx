...
export default function Insert({ setInsertTrue, count, setCount }) {
    ...
    const SubmitList = () => {
        if (!image || !title || !location || !famousPlace || !desc || !totalBudget) {
        ...
        <>
            <div className='AboutInsert' >
                <div className="container">
                    <div className="title">
                        <TextField value={image} name='image' placeholder='Image URL' onChange={(e) => setImage(e.target.value)} />
                        {image&&
                        <img style={{height:100,width:150}} src={image} alt="image not found" />
                        }
